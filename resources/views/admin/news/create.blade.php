                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="{{route('admin.news.store')}}" method="POST"
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical"
                                                                class="form-control" name="title_en" placeholder="Enter Here"
                                                                >
                                                        </div>
                                                        @error('title_en')
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <label for="exampleFormControlTextarea1" class="form-label">Example
                                                    ...
                                                    <textarea class="ckeditor" required="" name="description_en" ></textarea>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <label for="exampleFormControlTextarea1" class="form-label">
                                                    ...
                                                    <textarea class="ckeditor" required="" name="description_ar" ></textarea>
